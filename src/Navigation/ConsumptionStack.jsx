...
import Consumption2 from '../Screens/Consumption/Consumption2';
...
export default function ConsumptionStack() {
  return (
    <Stack.Navigator screenOptions={{headerShown: false}}>
      ...
      <Stack.Screen name="consumption" component={Consumption2} />
      <Stack.Screen name="consumptionInput" component={ConsumptionInput} />
      <Stack.Screen
        name="consumptionSuccessfull"
        component={ConsumptionSuccsessfull}
      />
    </Stack.Navigator>
  );
}
