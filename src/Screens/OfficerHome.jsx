...
const OfficerHome = ({ navigation }) => {
  ...
  const ITEMS = [
    ...
    {
      title: t('water'),
      navigation: 'officerWater',
      image: require('../../assets/water.png'),
    },
    {
      title: t('energy'),
      navigation: 'officerEnergy',
      image: require('../../assets/fuel.png'),
    },
    {
      title: t('mobility'),
      navigation: 'officerMobility',
      image: require('../../assets/mobility.png'),
    },
    {
      title: t('forestry'),
      navigation: 'officerForestry',
    ...
    {
      title: t('business'),
      navigation: 'officerBusiness',
      image: require('../../assets/business.png'),
    },
    {
      title: t('community'),
      navigation: 'officerCommunity',
        ...
        <View style={styles.mainContainer}>
          <Box style={[styles.user]}>
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('registerDetailsFieldOfficer', { edit: true })
              }>
