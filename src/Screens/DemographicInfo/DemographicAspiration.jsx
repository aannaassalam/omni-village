...
const DemographicAspiration = ({navigation, route}) => {
  ...
  const {mutate: edit_demographic, isPending: isEditing} = useMutation({
    ...
    onSuccess: data => {
      console.log('successsssss edit', data);
      queryClient.invalidateQueries();
      setDraftpopup(false), setSavepopup(false);
      navigation.replace('home');
    },
  ...
  const scheme = yup.object().shape({
    economic: yup
      .array()
      .required('Economic aspiration is required')
      .min(1, t('Atleast one economic aspiration is required')),
    educational: yup
      .array()
      .required('Educational aspiration is required')
      .min(1, t('Atleast one educational aspiration is required')),
    health_well_being: yup
      .array()
      .required('Health and well-being aspiration is required')
      .min(1, t('Atleast one health and well-being aspiration is required')),
    infrastructure_technology: yup
      .array()
      .required('Infrastructure and technology aspiration is required')
      .min(
        1,
        t('Atleast one infrastructure and technology aspiration is required'),
      ),
    environmental_sustainability: yup
      .array()
      .required('Environmental sustainability aspiration is required')
      .min(
        1,
        t('Atleast one environmental sustainability aspiration is required'),
      ),
    cultural: yup
      .array()
      .required('Cultural aspiration is required')
      .min(1, t('Atleast one cultural aspiration is required')),
    community_social: yup
      .array()
      .required('Community and social aspiration is required')
      .min(1, t('Atleast one community and social aspiration is required')),
    personal_growth: yup
      .array()
      .required('Personal growth aspiration is required')
      .min(1, t('Atleast one personal growth aspiration is required')),
    spiritual: yup
      .array()
      .required('Spiritual aspiration is required')
      .min(1, t('Atleast one spiritual aspiration is required')),
  ...
  useEffect(() => {
    resetForm({
      values: {
        economic:
          data?.aspiration?.economic.map(i => {
            return i?._id;
          }) || [],
        educational:
          data?.aspiration?.educational.map(i => {
            return i?._id;
          }) || [],
        health_well_being:
          data?.aspiration?.health_well_being.map(i => {
            return i?._id;
          }) || [],
        infrastructure_technology:
          data?.aspiration?.infrastructure_technology.map(i => {
            return i?._id;
          }) || [],
        environmental_sustainability:
          data?.aspiration?.environmental_sustainability.map(i => {
            return i?._id;
          }) || [],
        cultural:
          data?.aspiration?.cultural.map(i => {
            return i?._id;
          }) || [],
        community_social:
          data?.aspiration?.community_social.map(i => {
            return i?._id;
          }) || [],
        personal_growth:
          data?.aspiration?.personal_growth.map(i => {
            return i?._id;
          }) || [],
        spiritual:
          data?.aspiration?.spiritual.map(i => {
            return i?._id;
          }) || [],
          ...
          <View style={styles.innerInputView}>
            ...
            <View style={{width: '100%'}}>
              <MultiselectDropdown
                ...
                data={dropdownData?.['economic_aspirations'].map(item => {
                  return {name: item?.name, key: item?._id};
                })}
                setSelectedd={item => setValues({...values, economic: item})}
              ...
              <MultiselectDropdown
                ...
                data={dropdownData?.['educational_aspirations'].map(item => {
                  return {name: item?.name, key: item?._id};
                })}
                setSelectedd={item => setValues({...values, educational: item})}
              ...
              <MultiselectDropdown
                ...
                data={dropdownData?.['health_and_wellbeing_aspirations'].map(
                  item => {
                    return {name: item?.name, key: item?._id};
                  },
                )}
              ...
              {touched?.health_well_being && errors?.health_well_being && (
                <Text style={Styles.error2}>
                  {String(errors?.health_well_being)}
                </Text>
              )}
              <MultiselectDropdown
                containerStyle={{
              ...
              />
              {touched?.infrastructure_technology &&
                errors?.infrastructure_technology && (
                  <Text style={Styles.error2}>
                    {String(errors?.infrastructure_technology)}
                  </Text>
                )}
              <MultiselectDropdown
                containerStyle={{
              ...
              />
              {touched?.environmental_sustainability &&
                errors?.environmental_sustainability && (
                  <Text style={Styles.error2}>
                    {String(errors?.environmental_sustainability)}
                  </Text>
                )}
              <MultiselectDropdown
                containerStyle={{
                ...
                data={dropdownData?.['cultural_aspirations'].map(item => {
                  return {name: item?.name, key: item?._id};
                })}
                setSelectedd={item => setValues({...values, cultural: item})}
              ...
              <MultiselectDropdown
                ...
                data={dropdownData?.['community_and_social_aspirations'].map(
                  item => {
                    return {name: item?.name, key: item?._id};
                  },
                )}
              ...
              {touched?.community_social && errors?.community_social && (
                <Text style={Styles.error2}>
                  {String(errors?.community_social)}
                </Text>
              )}
              <MultiselectDropdown
                containerStyle={{
                ...
                data={dropdownData?.['aspiration_for_personal_growth'].map(
                  item => {
                    return {name: item?.name, key: item?._id};
                  },
                )}
              ...
              <MultiselectDropdown
                ...
                data={dropdownData?.['spiritual_aspiration'].map(item => {
                  return {name: item?.name, key: item?._id};
                })}
                setSelectedd={item => setValues({...values, spiritual: item})}
