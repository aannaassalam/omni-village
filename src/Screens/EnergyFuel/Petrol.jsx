...
const Petrol = ({navigation, route}) => {
  ...
  const scheme = yup.object().shape({
    yearly_petrol_consumption: yup
      .number()
      .required(t('Yearly petrol consumption required')),
    yearly_expenditure_petrol: yup
      .number()
      .required(t('Yearly expenditure on petrol is required')),
  ...
  return (
    <View style={styles.container}>
      ...
      <KeyboardAwareScrollView
        ...
        <Input
          label={t(`Yearly consumption of petrol`)}
        ...
        <Input
          label={t(`Yearly expenditure on petrol`)}
              ...
              <View style={styles.quantityContainer}>
                {values.purpose_petrol_used_for.map((item, index) => (
                  <>
                    <PurposeInput
                      title={`${
                        energy?.purpose_petrol.find(i => item?.type == i?._id)
                          ? energy?.purpose_petrol.find(
                              i => item?.type == i?._id,
