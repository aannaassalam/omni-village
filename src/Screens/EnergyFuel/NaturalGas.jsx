...
const NaturalGas = ({navigation, route}) => {
  ...
  const scheme = yup.object().shape({
    yearly_petrol_consumption: yup
      .number()
      .required(t('Yearly natural gas consumption required')),
    yearly_expenditure_petrol: yup
      .number()
      .required(t('Yearly expenditure on natural gas is required')),
  ...
  return (
    <View style={styles.container}>
      ...
      <KeyboardAwareScrollView
        ...
        <Input
          label={t(`Yearly consumption of natural gas`)}
        ...
        <Input
          label={t(`Yearly expenditure on natural gas`)}
              ...
              <View style={styles.quantityContainer}>
                {values.purpose_petrol_used_for.map((item, index) => (
                  <>
                    <PurposeInput
                      title={`${
                        energy?.purpose_natural_gas.find(
                          i => item?.type == i?._id,
                        )
                          ? energy?.purpose_natural_gas.find(
                              i => item?.type == i?._id,
