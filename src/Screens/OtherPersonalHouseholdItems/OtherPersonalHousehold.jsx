    ...
    <View style={styles.container}>
      ...
      <ScrollView>
        ...
        <CustomShowcaseInput
          ...
          onPress={() =>
            navigation.navigate('personalCare', {
              name: t('Personal Care Items'),
              type: 'personal_care_items',
            })
          }
        />
        <CustomShowcaseInput
          ...
          onPress={() =>
            navigation.navigate('cleaningProduct', {
              name: t('Cleaning Products'),
        ...
        <CustomShowcaseInput
          ...
          onPress={() =>
            navigation.navigate('officeSupplies', {
        ...
        <CustomShowcaseInput
          ...
          onPress={() =>
            navigation.navigate('kitchenItems', {
              name: t('Kitchen Items'),
              type: 'kitchen_items',
            })
          }
        />
