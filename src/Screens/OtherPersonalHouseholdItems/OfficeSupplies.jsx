...
const OfficeSupplies = ({ navigation, route }) => {
    ...
    const scheme = yup.object().shape({
        personal_care_item_use: yup.array().required(t('Office supplies used is required')),
        yearly_expense_for_personal_care: yup.number().required(t('Yearly expense for Office supplies is required')),
        ...
        <View style={styles.container}>
            ...
            <KeyboardAwareScrollView
                ...
                <MultiselectDropdown
                    ...
                    data={other_personal?.office_supplies
                ...
                <Input
                    label={t(
                        `Total yearly expense for Office supplies`
                    )}
                ...
                {values?.items_produced_locally ?
                    <>
                        <MultiselectDropdown
                            containerStyle={{ marginTop: '5%', paddingTop: 0 }}
                            data={other_personal?.office_supplies_produce
                                ...
                                <View style={{ width: '100%' }}>
                                    <View style={styles.quantityContainer}>
                                        {values.items_produces.map((item, index) => (
                                            <>
                                                <PurposeInput
                                                    title={`${other_personal?.office_supplies_produce
