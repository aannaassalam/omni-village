...
const OtherItems = ({navigation, route}) => {
  ...
  const scheme = yup.object().shape({
    personal_care_item_use: yup
      .array()
      .required(t('Other items used is required')),
    yearly_expense_for_personal_care: yup
      .number()
      .required(t('Yearly expense for Other items is required')),
        ...
        {values?.items_produced_locally ? (
          <>
            <MultiselectDropdown
              containerStyle={{marginTop: '5%', paddingTop: 0}}
              data={
                other_personal?.other_items_produce
