...
const PersonalCareItem = ({navigation, route}) => {
  ...
  const scheme = yup.object().shape({
    personal_care_item_use: yup
      .array()
      .min(1, 'personal care item use is required')
      .required(t('Personal care items used is required')),
    yearly_expense_for_personal_care: yup
      .number()
      .required(t('Yearly expense for personal care is required')),
                    ...
                    {values.items_produces.map((item, index) => (
                      <>
                        <PurposeInput
                          title={`${
                            other_personal?.personal_care_produce
                              ? other_personal?.personal_care_produce.find(
                                  i => item?.type == i?._id,
                                )
                                ? other_personal?.personal_care_produce.find(
                                    i => item?.type == i?._id,
...
export default PersonalCareItem;
