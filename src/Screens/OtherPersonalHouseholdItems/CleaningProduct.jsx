...
const CleaningProduct = ({navigation, route}) => {
  ...
  const scheme = yup.object().shape({
    personal_care_item_use: yup
      .array()
      .required(t('Cleaning Products used is required')),
    yearly_expense_for_personal_care: yup
      .number()
      .required(t('Yearly expense for Cleaning Products is required')),
    ...
    <View style={styles.container}>
      ...
      <KeyboardAwareScrollView
        ...
        <MultiselectDropdown
          ...
          data={
            other_personal?.cleaning_products
              ? other_personal?.cleaning_products.map(item => {
                  return {
        ...
        <Input
          label={t(`Total yearly expense for Cleaning Products`)}
        ...
        {values?.items_produced_locally ? (
          <>
            <MultiselectDropdown
              containerStyle={{marginTop: '5%', paddingTop: 0}}
              data={
                other_personal?.cleaning_products_produce
