...
const BusinessName = ({navigation, route}) => {
  ...
  const {
    ...
    onSubmit: async values => {
      ...
      navigation.navigate('businessEmployee', {
        businessName: new_data,
        id: id,
        name,
      });
    },
    ...
    <View style={styles.container}>
      ...
      <KeyboardAwareScrollView
        ...
        {touched.business_name && errors.business_name && (
          <Text style={Styles.error2}>{errors.business_name}</Text>
        )}
        <CustomDropdown
          data={
        ...
        {business_dropdown?.type_of_business.find(
          item => item?._id === values?.business_type,
        )?.name === 'Others(if any)' && (
          <Input
        ...
        />
        {touched.brief_description && errors.brief_description && (
          <Text style={Styles.error2}>{errors.brief_description}</Text>
        )}
        <CustomDropdown
          data={
        ...
        />
        {touched.land_area_utilised && errors.land_area_utilised && (
          <Text style={Styles.error2}>{errors.land_area_utilised}</Text>
        )}
        <Input
        ...
        {touched.built_up_area && errors.built_up_area && (
          <Text style={Styles.error2}>{errors.built_up_area}</Text>
        )}
      </KeyboardAwareScrollView>
