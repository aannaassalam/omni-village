    ...
    onSubmit: async values => {
      ...
      if (get_business_by_user?._id) {
        edit_business_by_user({
          ...values,
          number_of_business: parseInt(values?.number_of_business),
          business_by_user_id: get_business_by_user._id,
        });
      } else {
        add_business_by_user({
          ...values,
          number_of_business: parseInt(values?.number_of_business),
        });
      }
    ...
    if (get_business_by_user?._id) {
      setValues({
        other_business_apart_farming:
          get_business_by_user?.other_business_apart_farming,
      ...
      <ScrollView>
        ...
        <View style={styles.mainContainer}>
          <SwitchButton
            ...
            firstBtnPress={() =>
              setValues({...values, other_business_apart_farming: true})
            }
            secondBtnPress={() => {
              setValues({...values, other_business_apart_farming: false});
            }}
            firstBtnText={t('yes')}
            secondBtntext={t('no')}
          />
          <SwitchButton
            nolabel={false}
            label={t(
              'Do you have plan to start a new business or organisation?',
            )}
            selected={values?.plan_to_start_business}
            firstBtnPress={() =>
              setValues({...values, plan_to_start_business: true})
            }
            secondBtnPress={() => {
              setValues({...values, plan_to_start_business: false});
            }}
            firstBtnText={t('yes')}
            secondBtntext={t('no')}
          />
