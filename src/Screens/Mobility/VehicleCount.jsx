...
const VehicleCount = ({navigation}) => {
  ...
  const {
    ...
    isLoading: number_of_mobility_loading,
    refetch: number_of_mobility_loading_refetch,
    isFetching,
  } = useQuery({
      ...
      <View style={styles.mainContainer}>
            ...
            <TouchableOpacity
              ...
              onPress={() => {
                navigation.navigate('vehicleDetails', {
                  name: `${t('Vehicle')} ${index + 1}`,
                  mobility_id: item?._id,
                });
              }}>
        ...
        {get_mobility_by_user?.vehicle_requirement ? (
          <CustomShowcaseInput
            ...
            progressBar={false}
            onPress={() => {
              navigation.navigate('vehicleRequirements', {
                name: t('Vehicle Requirement'),
              });
            }}
          />
        ) : null}
