...
const VehicleRequirement = ({navigation, route}) => {
  ...
  useEffect(() => {
    resetForm({
      values: {
        vehicles_needed: get_mobility_requirement?.vehicles_needed.map(
          item => ({
    ...
    setSelectedStatus(
      String(get_mobility_requirement?.vehicles_needed.length || '') || '',
    );
  ...
  const handleStatusChange = selectedItems => {
    ...
    const updatedPurposeStatusOfLand = Array.from(
    ...
    <View style={styles.container}>
      ...
      <KeyboardAwareScrollView
        ...
        {/* <MultiselectDropdown
                ...
                /> */}
        <Input
          label={t(`How many vehicles do you need`)}
                    ...
                    <View style={styles.innerInputView}>
                      ...
                      <View style={{width: '100%'}}>
                        ...
                        {errors.vehicles_needed &&
                          errors.vehicles_needed[index]?.vehicle_type && (
                        ...
                        <CustomDropdown
                          data={[
                            {
                              label: 'Personal / Household Travel',
                              value: 'Personal / Household Travel',
                            },
                            {
                              label: 'Transporting Goods / Supplies',
                              value: 'Transporting Goods / Supplies',
                            },
                            {
                              label: 'Agricultural / Farm Tasks',
                              value: 'Agricultural / Farm Tasks',
                            },
                            {
                              label: 'Public / Shared Transportation',
                              value: 'Public / Shared Transportation',
                            },
                            {
                              label: 'Commercial / Business Use',
                              value: 'Commercial / Business Use',
                            },
                            {
                            ...
                            {
                              label: 'Community Services / Official Use',
                              value: 'Community Services / Official Use',
                            },
                            {
                              label: 'Educational Transportation',
                              value: 'Educational Transportation',
                            },
                          ]}
                          value={item?.purpose}
                          label={t('Purpose')}
                          onChange={value => {
                            handleFieldChange(index, 'purpose', value?.value);
                          }}
                        />
                        {errors.vehicles_needed &&
                          errors.vehicles_needed[index]?.purpose && (
                            <Text style={Styles.error2}>
                              {errors.vehicles_needed[index].purpose}
                            </Text>
                          )}
                        ...
                        <CustomDropdown
                          data={[
                            {label: 'Within 1 year', value: 'within 1 year'},
                            {
                              ...
                              value: 'within 2-5 years',
                            },
                            {
                              label: 'Within 5-10 years',
                              value: 'within 5-10 years',
                            },
                            {label: 'After 10 years', value: 'after 10 years'},
                          ]}
                          value={item?.urgency}
                          label={t('Urgency')}
                          onChange={value => {
                            handleFieldChange(index, 'urgency', value?.value);
                          }}
                        />
                        {errors.vehicles_needed &&
                          errors.vehicles_needed[index]?.urgency && (
                            <Text style={Styles.error2}>
                              {errors.vehicles_needed[index].urgency}
                            </Text>
                          )}
