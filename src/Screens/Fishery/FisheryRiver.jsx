                            ...
                            <TouchableOpacity
                                ...
                                onPress={() =>
                                    navigation.navigate('fisheryRiverInput', {
                                        ...
                                        cropId: fishery[0] !== undefined && fishery.find((j) => j?.fishery_crop?.name == element?.name) ? fishery.find((i) => i?.fishery_crop?.name == element?.name)._id : element?.id,
                                        data: fishery.find((i) => i?.fishery_crop_id == element?._id)
                                    })
                                ...
                                <AddAndDeleteCropButton
                                    ...
                                    onPress={() => handleRemoveClick(fishery[0] !== undefined && fishery.find((j) => j?.fishery_crop?.name == element?.name) ? fishery.find((i) => i?.fishery_crop?.name == element?.name)._id : element?.id, i)}
                                />
                            </TouchableOpacity>
                        );
                    })}
            ...
            {cropModal &&
                <AddBottomSheet>
                    ...
                    <View style={styles.dropdownSection}>
                        <CustomDropdown2
                            selectedValue={e => DropdownSelectedValue({ name: e, _id: fisheryCrop.find(cp => cp.name === e)?._id })}
