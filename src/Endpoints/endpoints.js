export const endpoints = {
  ...
  landholding:{
    ...
    edit_landholding_by_user:'/landholding-by-user/edit-landholding-by-user',
    get_number_of_landholding:'/landholding',
    get_landholding_details: '/landholding/get-landholding',
    add_landholding: '/landholding/add-landholding',
    update_landholding:'/landholding/update-landholding',
    delete_landholding: '/landholding/delete-landholding',
  ...
  housing:{
    ...
    edit_housing_by_user:'/housing-by-user/edit-housing-by-user',
    get_housing:'/housing',
    get_housing_details: '/housing/get-housing',
    add_housing: '/housing/add-housing',
    update_housing:'/housing/update-housing',
    delete_housing: '/housing/delete-housing',
  ...
  mobility:{
    ...
    edit_mobility_by_user:'/mobility-by-user/edit-mobility-by-user',
    get_number_of_mobility:'/mobility',
    get_mobility_details: '/mobility/get-mobility',
    add_mobility: '/mobility/add-mobility',
    delete_mobility: '/mobility/delete-mobility',
  ...
  business_commercial:{
    ...
    edit_business_by_user: '/business-by-user/edit-business-by-user',
    get_number_of_business: '/business-commercial',
    get_business_details: '/business-commercial/get-business',
    add_business: '/business-commercial/add-business',
    delete_business: '/business-commercial/delete-business',
